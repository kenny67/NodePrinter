...
class JsonExport {
    ...
    static writeMapToJson(strFileName, data) {
        let obj = Object.fromEntries(data);
        fs_1.default.writeFile(strFileName, JSON.stringify(obj), function (err) {
            if (err)
                throw err;
