...
export type FailedPrinterBindResult = PrinterBindResult & {
...
export type FailedPrinterUnbindResult = PrinterUnbindResult & {
    failureReason: string;
};
...
export declare const apiError: (code: ApiErrorCode, message: string) => ApiError;
export {};
